...
object Reading extends App {
  ...
  df.writeStream.format("csv").option("checkpointLocation", "/tmp/jenkins/Daniel/kafka/").option("path", "/tmp/jenkins/Daniel/kafka/FraudApib").start().awaitTermination()
